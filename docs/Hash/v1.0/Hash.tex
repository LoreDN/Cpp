...
\begin{document}
    ...
    \begin{minipage}{\textwidth}
        ...
        {\Huge Hash\_v1.0.1 --- Documentation} \\[0.5em]
        ...
        \libcategory{IF. Hash}
            ...
            \libclass{template <typename TYPE> \\[0.2em]
                ...
                \textcolor{black}{.} \quad protected: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] virtual const size\_t hash(const TYPE\& key) const noexcept = 0; \\[0.4cm]
                \textcolor{black}{.} \quad public: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] inline const size\_t\& getSize() const noexcept \{ return \\[0.2em]
                        \textcolor{black}{.} \qquad \qquad \quad this->size; \} \\[0.2em]
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] inline const size\_t\& getElements() const noexcept \{ return \\[0.2em]
                        \textcolor{black}{.} \qquad \qquad \quad this->elements; \} \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] virtual bool contains(const TYPE\& key) const noexcept = 0; \\[0.2em]
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] virtual std::string toString() const noexcept = 0; \\[0.4cm]
                \}; \\[0.4cm]
                ...
                \libfunction{[[nodiscard]] virtual const size\_t hash(const TYPE\& key) const noexcept = 0;} \noindent
                This \textit{virtual method} imposes that each \textbf{Hash-Structure} has to provide a method to hash a key.

                \libfunction{[[nodiscard]] inline const size\_t\& getSize() const noexcept \{ return this->size; \}} \noindent
                Getter for the attribute \code{Hash.size}.

                \libfunction{[[nodiscard]] inline const size\_t\& getElements() const noexcept \{ return this->elements; \}} \noindent
                Getter for the attribute \code{Hash.elements}.
                ...
                \libfunction{[[nodiscard]] virtual bool contains(const TYPE\& key) const noexcept = 0;} \noindent
                ...
                \libfunction{[[nodiscard]] virtual std::string toString() const noexcept = 0;} \noindent
        ...
        \libcategory{1. HashSet}
            ...
            \libclass{template <typename TYPE> \\[0.2em]
                ...
                \textcolor{black}{.} \quad public: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] inline const double loadFactor() const \{ \\[0.2em]
                ...
                \libfunction{[[nodiscard]] inline const double loadFactor() const} \noindent
        ...
        \libcategory{1.1 HashSet --> Open}
            ...
            \libclass{template <typename TYPE> \\[0.2em]
                ...
                \textcolor{black}{.} \quad private: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad // Method --- Hash Function \\[0.2em]
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] const size\_t hash(const TYPE\& key) const noexcept override; \\[0.4cm]
                \textcolor{black}{.} \quad public: \\[0.4cm]
                    \textcolor{black}{.} \qquad \quad // constructor \\[0.2em]
                    \textcolor{black}{.} \qquad \quad explicit Open(const size\_t\& sz); \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Open(const Open<TYPE>\& other) = delete; // copy constructor \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Open(Open<TYPE>\&\& other) noexcept = default; // move constructor \\[0.4cm]
                    \textcolor{black}{.} \qquad \quad // assignement \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Open<TYPE>\& operator=(const Open<TYPE>\& other) = delete; \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Open<TYPE>\& operator=(Open<TYPE>\&\& other) noexcept = default; \\[0.4cm]
                    \textcolor{black}{.} \qquad \quad // destructor \\[0.2em]
                ...
                \libfunction{[[nodiscard]] const size\_t hash(const TYPE\& key) const noexcept override;} \noindent
                ...
                \libclass{Open(const Open<TYPE>\& other) = delete; \\[0.2em]
                    Open(Open<TYPE>\&\& other) noexcept = default; \\[0.2em]
                    Open<TYPE>\& operator=(const Open<TYPE>\& other) = delete; \\[0.2em]
                    Open<TYPE>\& operator=(Open<TYPE>\&\& other) noexcept = default;
                } \noindent
                This are the \textit{copy/move constructors and assignement operators}, which have been enabled only for moving the \textbf{Hash-Set}.
        ...
        \libcategory{1.2 HashSet --> Close}
            ...
            \libclass{template <typename TYPE> \\[0.2em]
                ...
                \textcolor{black}{.} \quad public: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad Close(const Close<TYPE>\& other) = delete; // copy constructor \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Close(Close<TYPE>\&\& other) noexcept = default; // move constructor \\[0.4cm]
                    \textcolor{black}{.} \qquad \quad // assignement \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Close<TYPE>\& operator=(const Close<TYPE>\& other) = delete; \\[0.2em]
                    \textcolor{black}{.} \qquad \quad Close<TYPE>\& operator=(Close<TYPE>\&\& other) noexcept = default; \\[0.4cm]
                    \textcolor{black}{.} \qquad \quad // destructor \\[0.2em]
                ...
                \libclass{Close(const Close<TYPE>\& other) = delete; \\[0.2em]
                    Close(Close<TYPE>\&\& other) noexcept = default; \\[0.2em]
                    Close<TYPE>\& operator=(const Close<TYPE>\& other) = delete; \\[0.2em]
