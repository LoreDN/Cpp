...
\begin{document}
    ...
    \begin{minipage}{\textwidth}
        ...
        {\Huge Exception\_v1.0.1 --- Documentation} \\[0.5em]
    ...
    \section*{Classes Documentation} \addcontentsline{toc}{section}{Classes Documentation}
        ...
        In the \textit{"Exception"} library have been implemented a total of four classes:
        \begin{enumerate}
            
            \item[IF.] \textbf{LDN::Exception:} the Root Interface, from which all the other Exceptions derive from.
            \item \textbf{LDN::exception::Index:} handles out-of-memory limit acceses for a Data-Structure (as accessing to \code{array[i > size]}).
        ...
        \libcategory{IF. Exception}
            ...
            \libclass{class Exception \{ \\[0.4cm]
                ...
                \textcolor{black}{.} \quad public: \\[0.4cm]
                    ...
                    \textcolor{black}{.} \qquad \quad [[nodiscard]] inline const std::string\& getMessage() const noexcept \\[0.2em]
                    \textcolor{black}{.} \qquad \qquad \quad \{ return message; \} \\[0.4cm]
                ...
                \libfunction{[[nodiscard]] inline const std::string\& getMessage() const noexcept \{ return message; \}} \noindent
                Getter for the attribute \code{Exception.message}.
